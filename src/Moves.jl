...
"""
function get_moves(knight::Knight,board::Board)
...
function get_moves(bishop::Bishop,board::Board)
	tile = Tile(bishop)
...
function get_moves(rook::Rook,board::Board)
	tile = Tile(rook)
...
function get_moves(queen::Queen,board::Board)
	tile = Tile(queen)
...
function get_moves(king::King,board::Board)
...
board = Board()
initialize!(board)
pawn = board.board[2,5]
knight = board.board[1,2]
bishop = board.board[1,3]
rook = board.board[1,1]
# piece = getpiece(9,board)
# println("The piece is ",piece.label)

# kmoves = get_moves(knight,board)

# print_board(board)
# println("Moves are:")
# println(kmoves)
# println("Moving knight")
# move!(kmoves,knight,board,true)
# print_board(board)
test = get_moves(rook,board)
println(test)
